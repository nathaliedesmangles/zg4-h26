...
Utiliser le fichier **exo-semaine5.docx** pour y mettre vos réponses et captures d'écran.  
{{% button href="/docs/Exercices/exo-semaine5.docx" icon="download" %}}Télécharger le fichier docx{{% /button %}}
